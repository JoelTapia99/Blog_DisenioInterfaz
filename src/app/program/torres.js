...
function FichaS() {
    ...
    this.caja.style.backgroundColor = "#4f606d";
...
function FichaM() {
    ...
    this.caja.style.height = altura;
    this.caja.style.backgroundColor = "#2be249";
    this.caja.style.marginLeft = "auto";
    this.caja.style.marginRight = "auto";
    this.valor = 1;
}
...
function FichaL() {
    ...
    this.caja.style.height = altura;
    this.caja.style.backgroundColor = "#f21313";
    this.caja.style.marginLeft = "auto";
    this.caja.style.marginRight = "auto";
    this.valor = 2;
}
...
function FichaXL() {
    ...
    this.caja.style.height = altura;
    this.caja.style.backgroundColor = "#007bff";
    this.caja.style.marginLeft = "auto";
    this.caja.style.marginRight = "auto";
    this.valor = 3;
}
...
function Cuadro(cajaInicial) {
    ...
    this.caja.style.border = "solid #007bff";
...
function iniciar() {
    cuerpo = document.getElementById("dibujar-torre");
